# Estándares del proyecto HWE

Reglas que todo el código debe cumplir. Son prescriptivos — "haz esto, no hagas aquello".
Los agentes IA leen estos documentos antes de escribir código.

## Documentos

| Archivo | Contenido | Estado |
|---------|-----------|--------|
| [codigo.md](codigo.md) | Código limpio, complejidad, JSDoc, imports | ✅ Definido |
...
Si un estándar no está documentado aquí, no se puede exigir. Si se necesita una regla nueva, se debate primero en claude.ai (Nivel 3) y se añade al documento correspondiente.
